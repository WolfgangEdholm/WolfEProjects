...
@Component({
  selector: 'app-sv-modal',
  templateUrl: './sv-modal.component.html',
  styleUrls: ['./sv-modal.component.scss'],
  // Encapsulation None for changing size of MatSelect dropdown
  encapsulation: ViewEncapsulation.None,
})
export class SvModalComponent implements OnInit {
  ...
  constructor(
    ...
    private modalRef: MatDialogRef<SvModalSpec>,
    @Inject(MAT_DIALOG_DATA) public data: SvModalSpec,
