...
@Component({
  selector: 'app-query-integrity-report',
  templateUrl: './query-integrity-report.component.html',
  styleUrls: ['./query-integrity-report.component.scss']
})
export class QueryIntegrityReportComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.dsi.loadAllDataIntegrityItems().then(success => {
      if (success) {
        ...
        // Example of how to sort with names containing '.'
        // Don't delete
